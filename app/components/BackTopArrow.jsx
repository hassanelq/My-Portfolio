...
const BackToTop = () => {
  ...
  return (
    <Link
      ...
      className="arrow-container absolute bottom-29 sm:bottom-24 md:bottom-18 right-8 lg:bottom-18 block w-28 h-28 bg-gray-500 opacity-65 bg-opacity-30 rounded-full"
    >
